...
from btgym.ui.window import Ui_MainWindow
from btgym.utils.path import get_root_path
# from btgym.ui.scene_ui import SceneUI
...
class TaskThread(QThread):
    ...
    def run(self):
        self.env = self.task(self.scene_cls,self.robot_cls,self.scene_queue,self.ui_queue)
        self.env._run()
        # scene._run()
...
class UI(QMainWindow, Ui_MainWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        # 加载并显示图片
        # img_path = os.path.join(root_path, "btgym/utils/draw_bt/llm_test.png")
