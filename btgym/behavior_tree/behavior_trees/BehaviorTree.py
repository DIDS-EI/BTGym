...
from btgym.behavior_tree.utils.load import load_btml, print_tree_from_root
from btgym.behavior_tree.base_nodes import base_node_map, composite_node_map

import os
from btgym.utils.path import get_root_path
from btgym.utils.tree.tree_node import new_tree_like

from btgym.behavior_tree.base_nodes import base_node_map, composite_node_map,base_node_type_map
...
class BehaviorTree(ptree.trees.BehaviourTree):
    ...
    def draw(self,file_name="behavior_tree",png_only=False,target_directory=None):
        render_dot_tree(self.root,name=file_name,png_only=png_only,target_directory=target_directory)
...
if __name__ == '__main__':
    ...
    btml_path = os.path.join(root_path, '../../behavior_tree/utils/draw_bt/Default.btml')
    behavior_lib_path = os.path.join(root_path, '../../behavior_tree/exec_lib')
