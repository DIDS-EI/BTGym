...
from btgym.behavior_tree.constants import NODE_TYPE
from btgym.btgym.base.planning_condition import PlanningCondition
...
class CompositeActionPlanner:
    ...
    def plan_sub_bt_from_filtered_actions(self,agent_comp_sequence,comp_act_name):
        ...
        planning_algorithm = CABTGym(env=self.env, verbose=False, goal=frozenset(sub_goal), action_list=agent_comp_sequence)
