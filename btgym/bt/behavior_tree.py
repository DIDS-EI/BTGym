...
from btgym.bt.utils.visitor import StatusVisitor
from btgym.utils.any_tree_node import traverse_and_modify_tree

from btgym.bt.utils.draw import render_dot_tree
from btgym.bt.utils.load import print_tree_from_root
from btgym.bt.btml import load_btml

import os
from btgym.utils.path import get_root_path
from btgym.utils.any_tree_node import new_tree_like

from btgym.bt.base_nodes import base_node_map, control_node_map,base_node_type_map,composite_node_map

import copy
import sys
from btgym.utils.tools import print_colored
...
if __name__ == '__main__':
    ...
    btml_path = os.path.join(root_path, 'btgym/behavior_tree/utils/draw_bt/robot.bt')
    behavior_lib_path = os.path.join(root_path, 'btgym/behavior_tree/behavior_lib')
