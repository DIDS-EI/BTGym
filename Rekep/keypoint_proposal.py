...
class KeypointProposer:
    ...
    def get_keypoints(self, rgb, points, masks):
        ...
        # merge close points by clustering in cartesian space 通过在笛卡尔空间中聚类来合并接近的点
        ...
        # sort candidates by locations 按位置排序候选点
        ...
        # project keypoints to image space 将关键点投影到图像空间
